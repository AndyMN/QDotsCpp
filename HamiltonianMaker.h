#ifndef HAMILTONIANMAKER_H
#define HAMILTONIANMAKER_H
...
class HamiltonianMaker{
 public:
  HamiltonianMaker(Compound* compound, PotWell* potential_well,
  ...
  arma::cx_mat hamiltonian_luttinger_kohn(double k);
